  ...
  return (
    <div style={{ width: '45%' }}>
      <p style={{ color: '#f87d4e', fontSize: 18, marginBottom: 0 }}>
        Start by entering the Prescription OTP to initiate the Claim
      </p>
      <p style={{ color: 'grey', fontSize: 13 }}>
        Please ask the patient to provide the Prescription OTP to get the list of prescribed
      ...
      >
        ...
        >
          <span style={{ fontSize: 13 }}>Enter the prescription OTP here</span>
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: 'Please input valid Prescription OTP!',
              },
              {
                min: 8,
                max: 8,
                message: 'Prescription OTP must be 8 digit',
              },
            ]}
          ...
          >
            <Input
              ...
              placeholder="Enter the prescription OTP here"
              type="number"
              size="large"
